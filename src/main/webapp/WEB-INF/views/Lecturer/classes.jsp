...
<html>
  <head>
    ...
    <title>Class Management - myAttend+</title>
    ...
    <script src="${contextPath}/resources/class.js"></script>
  </head>
      ...
      <div class="drawer-content">
        ...
        <div class="w-auto my-10">
          ...
          >
            ...
            <div
              id="panelAttend"
              class="card card-compact md:basis-1/4 basis-full bg-white shadow-lg grow hidden"
            >
              <div class="card-body">
