...
<html>
  ...
  <body class="bg-neutral min-h-screen">
              ...
              <div class="card card-compact bg-base-100 shadow-xl">
                <div class="card-body">
                  <div class="card-title justify-between">
                    ...
                    <button
                      class="btn btn-sm btn-primary"
                      onclick="newStatus.showModal(); statusAdd.reset();"
                    >
                      New Status
                    </button>
                  </div>
                            ...
                            >
                              ...
                              >
                                ...
                                >
                                  ...
                                  <li>
                                    <a
                                      onclick="deleteStatus.showModal()"
                                      class="text-red-600 statusDelete"
                                      data-id="${user.getId()}"
                                      >Delete</a
                                    >
                                  </li>
    ...
    <dialog id="newStatus" class="modal">
      <div class="modal-box">
        <h3 class="font-bold text-lg">Add New Attendance Status</h3>
        <form
          id="statusAdd"
          action=""
          method="post"
    ...
    <dialog id="editStatus" class="modal">
      <div class="modal-box">
        <h3 class="font-bold text-lg">Edit Attendance Status</h3>
        <form action="" method="post" enctype="multipart/form-data">
          <input type="hidden" name="status_id" id="statusId" value="1" />
          <div class="flex flex-wrap gap-3">
            <label class="form-control basis-full">
              <div class="label">
                <span class="label-text">Status Description</span>
    ...
    <dialog id="deleteStatus" class="modal">
      <div class="modal-box">
        <h3 class="font-bold text-lg">Delete Status</h3>
        <p class="py-4">Do you really want to delete this status ?</p>
        <form action="" method="post">
          <input type="hidden" name="status_id" id="statusid" value="1" />
          <div class="modal-action">
            <button type="submit" class="btn btn-sm btn-error text-white">
